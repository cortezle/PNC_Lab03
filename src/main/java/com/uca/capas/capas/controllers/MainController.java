...
import com.uca.capas.capas.domain.Student;
...
public class MainController {
	...
	public @ResponseBody List<Student> ejemplo2(){
		return Arrays.asList(
				(new Student("Nombre1","Apellido1","10/11/2017","Carrera x",true)),
						(new Student("Nombre1","Apellido1","10/11/2017","Carrera Limon",true)
								)
				);
		}
